#ifndef __HfvclpOtaiDb7VpNII1xZG_h__
#define __HfvclpOtaiDb7VpNII1xZG_h__
...
#ifndef typedef_rigidBodyJoint_2
#define typedef_rigidBodyJoint_2

typedef struct tag_IXZbk4aPjQFR6fO0q1hmvH rigidBodyJoint_2;

#endif                                 /* typedef_rigidBodyJoint_2 */

#ifndef struct_tag_OXsSBS5uVDavZp4vbYKETG
#define struct_tag_OXsSBS5uVDavZp4vbYKETG

struct tag_OXsSBS5uVDavZp4vbYKETG
{
  boolean_T matlabCodegenIsDeleted;
  void* CollisionPrimitive;
};

#endif                                 /* struct_tag_OXsSBS5uVDavZp4vbYKETG */

#ifndef typedef_robotics_manip_internal_CollisionGeometry
#define typedef_robotics_manip_internal_CollisionGeometry

typedef struct tag_OXsSBS5uVDavZp4vbYKETG
...
struct tag_00yCXi7nR9pQk8H9si1uXF
{
  emxArray_unnamed_struct *CollisionGeometries;
  real_T MaxElements;
  robotics_manip_internal_CollisionGeometry _pobj0;
};

#endif                                 /* struct_tag_00yCXi7nR9pQk8H9si1uXF */

#ifndef typedef_robotics_manip_internal_CollisionSet
#define typedef_robotics_manip_internal_CollisionSet

typedef struct tag_00yCXi7nR9pQk8H9si1uXF robotics_manip_internal_CollisionSet;
...
struct tag_WMeMNR4DMNIJg72fJedFsF
{
  real_T Index;
...
#endif                                 /* struct_tag_WMeMNR4DMNIJg72fJedFsF */

#ifndef typedef_robotics_manip_internal_RigidBody
#define typedef_robotics_manip_internal_RigidBody

typedef struct tag_WMeMNR4DMNIJg72fJedFsF robotics_manip_internal_RigidBody;

#endif                                 /* typedef_robotics_manip_internal_RigidBody */

#ifndef struct_tag_nocrm47qO4AnMLS88M2yBF
#define struct_tag_nocrm47qO4AnMLS88M2yBF

struct tag_nocrm47qO4AnMLS88M2yBF
{
  real_T NumBodies;
  robotics_manip_internal_RigidBody Base;
  real_T Gravity[3];
  robotics_manip_internal_RigidBody *Bodies[11];
  real_T PositionDoFMap[22];
  real_T VelocityDoFMap[22];
  robotics_manip_internal_RigidBody _pobj0[11];
};

#endif                                 /* struct_tag_nocrm47qO4AnMLS88M2yBF */

#ifndef typedef_robotics_manip_internal_RigidBodyTree
#define typedef_robotics_manip_internal_RigidBodyTree

typedef struct tag_nocrm47qO4AnMLS88M2yBF robotics_manip_internal_RigidBodyTree;

#endif                                 /* typedef_robotics_manip_internal_RigidBodyTree */

#ifndef struct_tag_TYi0vrdSttogOrRWIvUogF
#define struct_tag_TYi0vrdSttogOrRWIvUogF

struct tag_TYi0vrdSttogOrRWIvUogF
{
  int32_T isInitialized;
  robotics_manip_internal_RigidBodyTree TreeInternal;
};

#endif                                 /* struct_tag_TYi0vrdSttogOrRWIvUogF */
...
typedef struct tag_TYi0vrdSttogOrRWIvUogF
  robotics_slmanip_internal_block_InverseDynamicsBlock;

#endif                                 /* typedef_robotics_slmanip_internal_block_InverseDynamicsBlock */

#ifndef struct_tag_sz5ojg5MkcK15DUz148ISjE
#define struct_tag_sz5ojg5MkcK15DUz148ISjE

struct tag_sz5ojg5MkcK15DUz148ISjE
{
  uint8_T Type;
  real_T NameLength;
  uint8_T Name[30];
...
#endif                                 /* struct_tag_sz5ojg5MkcK15DUz148ISjE */

#ifndef typedef_sz5ojg5MkcK15DUz148ISjE
#define typedef_sz5ojg5MkcK15DUz148ISjE

typedef struct tag_sz5ojg5MkcK15DUz148ISjE sz5ojg5MkcK15DUz148ISjE;

#endif                                 /* typedef_sz5ojg5MkcK15DUz148ISjE */
...
typedef struct tag_ddvrp0fHZh8itY76SLSutH k_cell;

#endif                                 /* typedef_k_cell */

#ifndef struct_tag_s8gQ8EYaRj2oyEKou0THeb
#define struct_tag_s8gQ8EYaRj2oyEKou0THeb

struct tag_s8gQ8EYaRj2oyEKou0THeb
{
  real_T NameLength;
  uint8_T Name[14];
  real_T ParentIndex;
  real_T NumChildren;
  real_T ChildrenIndices[11];
  real_T Mass;
...
#endif                                 /* struct_tag_s8gQ8EYaRj2oyEKou0THeb */

#ifndef typedef_s8gQ8EYaRj2oyEKou0THeb
#define typedef_s8gQ8EYaRj2oyEKou0THeb

typedef struct tag_s8gQ8EYaRj2oyEKou0THeb s8gQ8EYaRj2oyEKou0THeb;

#endif                                 /* typedef_s8gQ8EYaRj2oyEKou0THeb */

#ifndef struct_tag_kNrpw0U4q7ZR2ZfVD4rXTH
#define struct_tag_kNrpw0U4q7ZR2ZfVD4rXTH

struct tag_kNrpw0U4q7ZR2ZfVD4rXTH
{
  s8gQ8EYaRj2oyEKou0THeb f1;
  s8gQ8EYaRj2oyEKou0THeb f2;
  s8gQ8EYaRj2oyEKou0THeb f3;
  s8gQ8EYaRj2oyEKou0THeb f4;
  s8gQ8EYaRj2oyEKou0THeb f5;
  s8gQ8EYaRj2oyEKou0THeb f6;
  s8gQ8EYaRj2oyEKou0THeb f7;
  s8gQ8EYaRj2oyEKou0THeb f8;
  s8gQ8EYaRj2oyEKou0THeb f9;
  s8gQ8EYaRj2oyEKou0THeb f10;
  s8gQ8EYaRj2oyEKou0THeb f11;
  s8gQ8EYaRj2oyEKou0THeb f12;
};

#endif                                 /* struct_tag_kNrpw0U4q7ZR2ZfVD4rXTH */

#ifndef typedef_s_kNrpw0U4q7ZR2ZfVD4rXTH
#define typedef_s_kNrpw0U4q7ZR2ZfVD4rXTH

typedef struct tag_kNrpw0U4q7ZR2ZfVD4rXTH s_kNrpw0U4q7ZR2ZfVD4rXTH;

#endif                                 /* typedef_s_kNrpw0U4q7ZR2ZfVD4rXTH */

#ifndef struct_tag_R5CdNwLM45r816Y3sizuaB
#define struct_tag_R5CdNwLM45r816Y3sizuaB

struct tag_R5CdNwLM45r816Y3sizuaB
{
  s_kNrpw0U4q7ZR2ZfVD4rXTH _data;
};

#endif                                 /* struct_tag_R5CdNwLM45r816Y3sizuaB */

#ifndef typedef_s_R5CdNwLM45r816Y3sizuaB
#define typedef_s_R5CdNwLM45r816Y3sizuaB

typedef struct tag_R5CdNwLM45r816Y3sizuaB s_R5CdNwLM45r816Y3sizuaB;

#endif                                 /* typedef_s_R5CdNwLM45r816Y3sizuaB */

#ifndef struct_tag_WLLISmpPcnSajwmZOykQJB
#define struct_tag_WLLISmpPcnSajwmZOykQJB

struct tag_WLLISmpPcnSajwmZOykQJB
{
  real_T NumBodies;
  real_T Gravity[3];
  ...
  s_R5CdNwLM45r816Y3sizuaB Bodies;
  sz5ojg5MkcK15DUz148ISjE Joints[12];
};

#endif                                 /* struct_tag_WLLISmpPcnSajwmZOykQJB */

#ifndef typedef_s_WLLISmpPcnSajwmZOykQJB
#define typedef_s_WLLISmpPcnSajwmZOykQJB

typedef struct tag_WLLISmpPcnSajwmZOykQJB s_WLLISmpPcnSajwmZOykQJB;

#endif                                 /* typedef_s_WLLISmpPcnSajwmZOykQJB */
...
#ifndef typedef_InstanceStruct_HfvclpOtaiDb7VpNII1xZG
#define typedef_InstanceStruct_HfvclpOtaiDb7VpNII1xZG
...
#endif                                 /* typedef_InstanceStruct_HfvclpOtaiDb7VpNII1xZG */
...
extern void method_dispatcher_HfvclpOtaiDb7VpNII1xZG(SimStruct *S, int_T method,
  void* data);
