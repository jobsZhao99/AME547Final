...
#endif
#include "nesl_rtw.h"
#include "ur5bh_47770016_1.h"
#include "ur5bh_47770016_1_gateway.h"
void ur5bh_47770016_1_gateway ( void ) { NeModelParameters modelparams = { (
NeSolverType ) 1 , 0.001 , 1 , 0 , 0.001 , 0 , 0 , 0 , 0 , (
SscLoggingSetting ) 0 , 591149874 , 0 , } ; NeSolverParameters solverparams =
...
ur5bh_47770016_1_dae ( & dae , & modelparams , & solverparams ) ;
nesl_register_simulator_group ( "ur5bh/Dynamic/Solver Configuration_1" , 1 ,
